...
release_tag="$1"
# Service images
images="${IMAGES:-zipkin-cassandra zipkin-elasticsearch zipkin-kafka zipkin-web zipkin-mysql zipkin}"
dirs="${DIRS:-cassandra elasticsearch kafka web mysql zipkin}"
# Remotes, auth
